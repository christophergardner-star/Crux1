...
def main():
    ...
    # Initialize Cruxy Optimizer in Meta3 mode with SOTA features
    print("Initializing Cruxy Stability Engine (Meta3) with SOTA features...")
    optimizer = CruxyOptimizer(
        ...
        use_nesterov=True,           # Nesterov Momentum
        use_gc=True,                 # Gradient Centralization (SOTA for Vision)
        meta_lr_eta=1e-4,            # Corrected arg name
        meta_interval=10
    )
